...
[![CRAN status](https://www.r-pkg.org/badges/version/seine)](https://CRAN.R-project.org/package=seine)
<!-- badges: end -->
...
*Situates `seine` in the broader ecological inference literature, explains the importance of confounders in ecological inference, and synthesizes existing methods in the regression framework.*
