...
identifying assumptions and proper estimation methods, researchers can
easily draw incorrect conclusions from aggregate data, finding patterns
where none exist, missing important individual-level patterns, or even
concluding an effect runs in the opposite direction than it actually
does. This is known as the *ecological fallacy*.
...
[arXiv:2509.20194](https://arxiv.org/abs/2509.20194). *Develops the
estimator implemented in `seine`.*

Kuriwaki, S. and McCartan, C., 2026. The Role of Confounders and
Linearity in Ecological Inference: A Reassessment.
[arXiv:2601.07668](https://arxiv.org/abs/2601.07668) *Situates `seine`
in the broader ecological inference literature, explains the importance
of confounders in ecological inference, and synthesizes existing methods
